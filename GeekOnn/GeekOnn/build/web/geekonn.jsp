      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav pull-right">
              <li><a href="geekonn.jsp" id="nav-imgUsuario-Nombre"><%=(String)session.getAttribute("sessionUsername")%></a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
          ...
          <div class="row-fluid contenedor-principal">
              <div class="span8 offset1 top" id="recibidor-ajax-geekonn">
                  ...
                  <%SentenciasSQL sentenciaSQL =  new SentenciasSQL();
                                ResultSet resultset = sentenciaSQL.todasPublicaciones();
                      ...
                      <div class="row-fluid publicacion">
                          <div class="span9">
                              ...
                              <hr>
                              <center><h4>Comentarios</h4></center><hr>
                              <%ResultSet resultado = sentenciaSQL.todosComentarios(resultset.getInt("idPublicacion"));%>
                              <%while(resultado.next()){
                                out.println(resultado.getString("comentarios") + "<br>");
                              }%>
                              <hr>
                              <center><textarea rows="3" class="span10" onkeyup="comentario(this.value)"></textarea></center>
                              <%int idPublicacion =resultset.getInt("idPublicacion");%>
                              <center><button type="button"  class="btn btn-info" onclick="comentar(this.name)" name=<%=idPublicacion%>><i class="icon-refresh icon-white"></i>&nbsp;Cometa tu opinion</button></center>
                        </div>
                          </div>
                      </div>
                  </div>
