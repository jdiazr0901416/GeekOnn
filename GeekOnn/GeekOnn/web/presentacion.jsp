    ...
    <!-- Termina navbar  -->
      <div class="row-fluid" id="recibidor">
          <div class="row-fluid header">
            <div class="span6 offset3 titulo-header-p">
              <center><p>GeekOnn</p></center>
              <br>
              <h3 class="pull-right">BETA 4.0</h3>
            </div>         
          </div>
          ...
          <div class="span8 offset2 contenedor-index">
              ...
              <div class="row-fluid fucion">
                  <center><i class="icon-twitter"></i><i class="icon-plus left"></i><i class="icon-off left"></i></center>
              </div>
          </div>
